...
$tb = "daftar_hadir_dosen";
$array_field = array("kd_jurusan","daftar_hadir_dosen");
$array_value = array($_POST['id_daftar_hadir_dosen'],$_POST['daftar_hadir_dosen']);
$id_field = "id_daftar_hadir_dosen";
$id_value = $_POST['id_daftar_hadir_dosen'];
