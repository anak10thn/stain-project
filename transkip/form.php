 ...
 * 
 */
$array_label = array("Id Transkip : ","Id Mahasiswa : ","Kode Jurusan : ","Kode Prodi : ","Kode Matakuliah : ","Sks : ","Angka : ","Semester : ","","");
$array_type = array("text","text","text","text","text","text","text","text","hidden","submit");
$array_name = array("id_transkip","id_mahasiswa","kd_jurusan","kd_prodi","kd_matakuliah","sks","angka","semester","update","kirim");
$array_value = array("","","","","","","","","no","Submit");
$tag_app = "<tr><td><fieldset>:</fieldset></td></tr>";
$tag_opt = "<tr><td><div id='button'>:</div></td></tr>";
$array_class = "effect";
$array_id = $array_name;
$input_tag = array($tag_app,$tag_app,$tag_app,$tag_app,$tag_app,$tag_app,$tag_app,$tag_app,$tag_opt,$tag_opt);
