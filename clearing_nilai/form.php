 ...
 * 
 */
$modul_name = "clearing_nilai";
$array_label = array("Id Clearing : ","Id Mahasiswa : ","Kode Matakuliah : ","Semester : ","Sks : ","Nh : ","Na : ","Kxn : ","Keterangan : ","","");
$array_type = array("text","text","text","text","text","text","text","text","text","hidden","submit");
$array_name = array("id_clearing","id_mahasiswa","kd_matakuliah","semester","sks","nh","na","kxn","keterangan","update","kirim");
