...
$tb = "daftar_hadir_kuliah";
$array_field = array("id_daftar_hadir_kuliah","daftar_hadir_kuliah");
$array_value = array($_POST['id_daftar_hadir_kuliahn'],$_POST['daftar_hadir_kuliah']);
$id_field = "id_daftar_hadir_kuliahn";
$id_value = $_POST['id_daftar_hadir_kuliah'];
